...
export function MatchingModal({ isOpen, onClose, type }: MatchingModalProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    qualification: "",
    height: "",
    maritalStatus: "", // Added maritalStatus here
  });
  ...
  const [dynamicOptions, setDynamicOptions] = useState({
    ...
    age: AGE_OPTIONS,
    maritalStatus: ["Single", "Divorced", "Widowed", "Separated", "Other"], // Added maritalStatus options
  });
  ...
  const handleClose = () => {
    ...
    setFormData({
      ...
      qualification: "",
      height: "",
      maritalStatus: "", // reset maritalStatus
    });
    setMatchResult(null);
    onClose();
  };
